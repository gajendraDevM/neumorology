...
export default function About() {
  return (
    <div className='h-[700px] ' style={{backgroundImage:`url('${bg2}')`}}>

        <div className="grid grid-cols-2 h-full p-5 w-[85%] mx-auto gap-14">
...
<img src={about} alt="" style={{boxShadow:"-40px 40px #0c3852"}}  />
            ...
            <div className='flex items-center'>
                <div>
                 <Title left="15%" title="Know About Ichlkranji numerrology"/>
                 <br/>
                 <br/>
                 <p className='text-white text-lg  font-[400] w-[75%] opacity-70 '>
                 ...
                 <Button text="Read More"/>
                    <br/> <br/>
                 <div className='grid grid-cols-4 w-[70%] bg-[#114a6b77] py-4 px-1 rounded'>
